...
#                                 "/h2gis-dist-",
#                                 "-bin.zip"])
# H2GIS_UNZIPPED_NAME = "h2gis_standalone"+os.sep+"h2gis-dist-"+H2GIS_VERSION+".jar"
...
def startH2gisInstance(dbDirectory, dbInstanceDir, instanceName = "myDbH2",
                       instanceId="sa", instancePass = "sa"):
